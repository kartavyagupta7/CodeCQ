 ...
 //
   ...
   if(!$con)
	echo("failed");
  	...
  	//
    $inq1="update Test set Testpassword='$testpass', Adminpassword='$adminpass', maxtime='$maxtime' where Testid=$testid;";
...
<body>
	...
	<table border="0px" style="width: 100%;">
		...
		<tr >
			<td><b>Test Password: <?php echo $_POST["testpassword"];?></b></td>
			<td><b>Admin Password: <?php echo $_POST["adminpassword"];?></b></td>
			<td><b>Max Time: <?php echo $_POST["totaltime"];?></b></td>
		</tr>
	</table>
	<hr>
